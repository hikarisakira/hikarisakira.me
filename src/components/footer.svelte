...
<footer class="footer items-center p-4 fixed inset-x-0 bottom-0">
    <aside class="items-center grid-flow-col md:fixed md:place-self-center md:justify-self-start">
        <p>Copyleft (ɔ) Hikari Sakira, 2024</p>
    </aside>
